...
app.directive('ngFileSelect', ['$fileUploader', '$parse', '$timeout',  function($fileUploader, $parse, $timeout) {
    'use strict';
    ...
    return {
        link: function(scope, element, attributes) {
            ...
            element.bind('change', function() {
                ...
                var options = scope.$eval(attributes.ngFileSelect, data);
        ...
        addToQueue: function(items, options) {
            ...
            angular.forEach(list, function(file) {
                ...
                var item = new Item(angular.extend({
                    url: options && options.url ? options.url : this.url,
                    description: options && options.description ? options.description : this.url,
//                    onComplete: options && options.onComplete ? options.onComplete : null,
                    alias: this.alias,
